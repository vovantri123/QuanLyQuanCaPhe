...
BEGIN 
	BEGIN TRY
		...
		BEGIN
			RAISERROR (N'Nhân viên này không được làm quá 2 ca trong 1 ngày. Vui lòng kiểm tra lại.', 16, 1); --Khi RAISERROR thì trigger tự động rollback nên k cần phải return
		END
